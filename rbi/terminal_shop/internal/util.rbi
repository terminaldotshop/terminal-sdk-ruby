      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            TerminalShop::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: TerminalShop::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: TerminalShop::Internal::Util::ParsedUri,
            rhs: TerminalShop::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
