  ...
  module Resources
    class Card
      sig do
        ...
        ).returns(Terminal::Models::CardCreateResponse)
      end
      ...
      sig do
        ...
        ).returns(Terminal::Models::CardListResponse)
      end
      ...
      sig do
        params(
          id: String,
          request_options: T.nilable(T.any(Terminal::RequestOptions, T::Hash[Symbol, T.anything]))
        ).returns(Terminal::Models::CardDeleteResponse)
      end
      ...
      sig do
        ...
        ).returns(Terminal::Models::CardCollectResponse)
      end
