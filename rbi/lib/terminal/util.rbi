...
module Terminal
  module Util
    ...
    sig { params(url: T.any(URI::Generic, String)).returns(Terminal::Util::ParsedUriShape) }
    def self.parse_uri(url)
    end

    sig { params(parsed: Terminal::Util::ParsedUriShape).returns(URI::Generic) }
    def self.unparse_uri(parsed)
    end

    sig do
      params(lhs: Terminal::Util::ParsedUriShape, rhs: Terminal::Util::ParsedUriShape).returns(URI::Generic)
    end
