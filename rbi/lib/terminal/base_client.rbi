...
module Terminal
  class BaseClient
    ...
    RequestShape = T.type_alias do
      {
        ...
        page: T.nilable(T::Class[Terminal::BaseModel]),
        model: T.nilable(Terminal::Converter::Input),
        options: T.nilable(T.any(Terminal::RequestOptions, T::Hash[Symbol, T.anything]))
      }
    end
    ...
    sig { params(req: Terminal::BaseClient::RequestShape).void }
    ...
    sig do
      params(
        req: Terminal::BaseClient::RequestShape,
        opts: T::Hash[Symbol, T.anything]
      ).returns(Terminal::BaseClient::NormalizedRequestShape)
    end
    ...
    sig do
      params(
        request: Terminal::BaseClient::NormalizedRequestShape,
        status: Integer,
    ...
    sig { params(req: Terminal::BaseClient::RequestShape, response: NilClass).returns(T.anything) }
