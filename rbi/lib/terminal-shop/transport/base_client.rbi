...
module TerminalShop
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[TerminalShop::Type::BasePage[TerminalShop::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(TerminalShop::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: TerminalShop::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: TerminalShop::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(TerminalShop::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(TerminalShop::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(
            req: TerminalShop::Transport::BaseClient::RequestComponentsShape,
            opts: TerminalShop::Util::AnyHash
          )
          .returns(TerminalShop::Transport::BaseClient::RequestInputShape)
      end
