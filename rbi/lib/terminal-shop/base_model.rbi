...
module TerminalShop
  ...
  module Converter
    ...
    # @api private
    sig { overridable.params(value: T.anything, state: TerminalShop::Converter::State).returns(T.anything) }
    ...
    class << self
      ...
      sig do
        params(
          target: TerminalShop::Converter::Input,
          value: T.anything,
          state: TerminalShop::Converter::State
        )
          .returns(T.anything)
      end
      def self.coerce(
  ...
  class Unknown
    ...
    class << self
      # @api private
      sig(:final) do
        override.params(value: T.anything, state: TerminalShop::Converter::State).returns(T.anything)
      end
      def coerce(value, state:)
      end
  ...
  class BooleanModel
    ...
    class << self
      ...
      sig(:final) do
        override
          .params(value: T.any(T::Boolean, T.anything), state: TerminalShop::Converter::State)
  ...
  module Enum
    ...
    sig do
      override
        .params(value: T.any(String, Symbol, T.anything), state: TerminalShop::Converter::State)
  ...
  module Union
    ...
    # @api private
    sig { override.params(value: T.anything, state: TerminalShop::Converter::State).returns(T.anything) }
    def coerce(value, state:)
    end
  ...
  class ArrayOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Enumerable[T.anything], T.anything), state: TerminalShop::Converter::State)
  ...
  class BaseModel
    ...
    class << self
      ...
      sig do
        override
          .params(
            value: T.any(TerminalShop::BaseModel, T::Hash[T.anything, T.anything], T.anything),
            state: TerminalShop::Converter::State
          )
