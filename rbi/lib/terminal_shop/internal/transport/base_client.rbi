  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        class << self
          # @api private
          sig { params(req: TerminalShop::Internal::Transport::BaseClient::RequestComponentsShape).void }
          def validate!(req)
          end
          ...
          sig do
            params(
              request: TerminalShop::Internal::Transport::BaseClient::RequestInputShape,
              status: Integer,
