...
module TerminalShop
  module Internal
    ...
    module Util
      ...
      #   structure when using `TerminalShop::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(TerminalShop::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        # @api private
        sig { params(url: T.any(URI::Generic, String)).returns(TerminalShop::Internal::Util::ParsedUriShape) }
        def parse_uri(url)
        end

        # @api private
        sig { params(parsed: TerminalShop::Internal::Util::ParsedUriShape).returns(URI::Generic) }
        ...
        sig do
          params(
            lhs: TerminalShop::Internal::Util::ParsedUriShape,
            rhs: TerminalShop::Internal::Util::ParsedUriShape
          )
            .returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(TerminalShop::Internal::Util::ServerSentEvent) }
