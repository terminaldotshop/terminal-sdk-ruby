  ...
  module Internal
    ...
    module Util
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(TerminalShop::Internal::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(T::Enumerable[TerminalShop::Internal::Util::ServerSentEvent])
        end
