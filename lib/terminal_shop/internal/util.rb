    ...
    module Util
      ...
      class << self
        ...
        def encode_path(path)
          path.to_s.gsub(TerminalShop::Internal::Util::RFC_3986_NOT_PCHARS) { ERB::Util.url_encode(_1) }
        end
      ...
      class << self
        ...
        private def write_multipart_chunk(y, boundary:, key:, val:, closing:)
          ...
          case val
          in TerminalShop::FilePart unless val.filename.nil?
