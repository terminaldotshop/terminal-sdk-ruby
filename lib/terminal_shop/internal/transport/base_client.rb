  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => TerminalShop::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => TerminalShop::Internal::Util.os,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = TerminalShop::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            location =
              Kernel.then do
                ...
                raise TerminalShop::Errors::APIConnectionError.new(
                  url: url,
            ...
            # from undici
            if TerminalShop::Internal::Util.uri_origin(url) != TerminalShop::Internal::Util.uri_origin(location)
          ...
          def reap_connection!(status, stream:)
            ...
            in TerminalShop::Errors::APIConnectionError | (500..)
              TerminalShop::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        def initialize(
          ...
          @requester = TerminalShop::Internal::Transport::PooledNetRequester.new
          @headers = TerminalShop::Internal::Util.normalized_headers(
        ...
        #
        # @return [String]
        private def user_agent = "#{self.class.name}/Ruby #{TerminalShop::VERSION}"
        ...
        #
        #   @option req [Class<TerminalShop::Internal::Type::BaseStream>, nil] :stream
        #
        ...
        private def build_request(req, opts)
          ...
          path = TerminalShop::Internal::Util.interpolate_path(uninterpolated_path)

          query = TerminalShop::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
        ...
        def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          in 300..399 if redirect_count >= self.class::MAX_REDIRECTS
            ...
            raise TerminalShop::Errors::APIConnectionError.new(url: url, response: response, message: message)
          in 300..399
            self.class.reap_connection!(status, stream: stream)
        ...
        #
        # @param stream [Class<TerminalShop::Internal::Type::BaseStream>, nil]
        #
