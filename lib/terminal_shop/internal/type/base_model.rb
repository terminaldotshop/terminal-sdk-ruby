    ...
    module Type
      ...
      class BaseModel
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            ...
            type_fn, info =
              ...
              in Proc | TerminalShop::Internal::Type::Converter | Class
                [TerminalShop::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [TerminalShop::Internal::Type::Converter.type_info(type_info), type_info]
              end
            ...
            define_method(setter) do |value|
              target = type_fn.call
              state = TerminalShop::Internal::Type::Converter.new_coerce_state(translate_names: false)
              ...
              stored =
                case [target, status]
                in [TerminalShop::Internal::Type::Converter | Symbol, true]
                  coerced
                else
                  value
                end
            ...
            define_method(name_sym) do
              ...
              in true | false if TerminalShop::Internal::Type::Converter === target
                @data.fetch(name_sym)
              in ::StandardError => e
                raise TerminalShop::Errors::ConversionError.new(
                  on: self.class,
                  method: __method__,
                  target: target,
                ...
                Kernel.then do
                  value = @data.fetch(name_sym) { const == TerminalShop::Internal::OMIT ? nil : const }
                  state = TerminalShop::Internal::Type::Converter.new_coerce_state(translate_names: false)
                  if (nilable || !required) && value.nil?
                    nil
                  else
                    TerminalShop::Internal::Type::Converter.coerce(
        ...
        class << self
          # @api private
          #
          # @param value [TerminalShop::Internal::Type::BaseModel, Hash{Object=>Object}, Object]
          #
          ...
          def coerce(value, state:)
            ...
            unless (val = TerminalShop::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
            ...
            fields.each do |name, field|
              ...
              unless val.key?(src_name)
                if required && mode != :dump && const == TerminalShop::Internal::OMIT
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = TerminalShop::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in TerminalShop::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = TerminalShop::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, TerminalShop::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
        ...
        #
        # @return [String]
        def to_yaml(*a) = TerminalShop::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        def initialize(data = {})
          @data = {}
          @coerced = {}
          TerminalShop::Internal::Util.coerce_hash!(data).each do
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                TerminalShop::Internal::Type::Converter.inspect(type, depth: depth),
