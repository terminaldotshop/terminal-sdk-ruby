  ...
  module Internal
    module Type
      ...
      module Union
        ...
        # @api private
        #
        # @param key [Symbol, Hash{Symbol=>Object}, Proc, TerminalShop::Internal::Type::Converter, Class]
        #
        ...
        def dump(value)
          if (target = resolve_variant(value))
            return TerminalShop::Internal::Type::Converter.dump(target, value)
          end

          known_variants.each do
            target = _2.call
            return TerminalShop::Internal::Type::Converter.dump(target, value) if target === value
          end
