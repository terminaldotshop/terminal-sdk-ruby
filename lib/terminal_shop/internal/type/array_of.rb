    ...
    module Type
      ...
      class ArrayOf
        ...
        def ==(other)
          ...
          other.is_a?(TerminalShop::Internal::Type::ArrayOf) && other.nilable? == nilable? && other.item_type == item_type
          ...
          value
            .map do |item|
              ...
              in [true, nil]
                ...
                TerminalShop::Internal::Type::Converter.coerce(target, item, state: state)
              end
            end
        end
        ...
        def inspect(depth: 0)
          # rubocop:disable Layout/LineLength
          "#{self.class}[#{[TerminalShop::Internal::Type::Converter.inspect(item_type, depth: depth.succ), nilable? ? 'nil' : nil].compact.join(' | ')}]"
          # rubocop:enable Layout/LineLength
        end
      end
    end
