...
module Terminal
  module Models
    ...
    #   id: String,
    #   token: String,
    #   time: Terminal::Models::TokenAPI::Time
    # }
    # ```
    class TokenAPI < Terminal::BaseModel
      ...
      #
      #   @return [Terminal::Models::TokenAPI::Time]
      required :time, -> { Terminal::Models::TokenAPI::Time }
      ...
      #   # @param id [String]
      #   # @param token [String]
      #   # @param time [Terminal::Models::TokenAPI::Time]
      #   #
