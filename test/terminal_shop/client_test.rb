...
class TerminalShopTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:get, "http://localhost/product").to_return_json(status: 500, body: {})

    terminal = TerminalShop::Client.new(base_url: "http://localhost", bearer_token: "My Bearer Token")
  ...
  def test_client_given_request_default_retry_attempts
    ...
    terminal =
      TerminalShop::Client.new(base_url: "http://localhost", bearer_token: "My Bearer Token", max_retries: 3)
  ...
  def test_client_redirect_307
    ...
    assert_requested(:any, "http://localhost/redirected", times: TerminalShop::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: TerminalShop::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: TerminalShop::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:get, "http://localhost/product").to_return_json(status: 200, body: {})
