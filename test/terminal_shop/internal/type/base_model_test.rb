...
class TerminalShop::Test::PrimitiveModelTest < Minitest::Test
  A = TerminalShop::Internal::Type::ArrayOf[-> { Integer }]
  H = TerminalShop::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < TerminalShop::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      TerminalShop::Internal::Type::Unknown,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => TerminalShop::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [TerminalShop::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [TerminalShop::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [TerminalShop::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      assert_pattern do
        TerminalShop::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [TerminalShop::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [TerminalShop::Internal::Type::Boolean, true] => true,
      [TerminalShop::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => TerminalShop::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        TerminalShop::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = TerminalShop::Internal::Type::Converter.new_coerce_state
      TerminalShop::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        TerminalShop::Internal::Type::Converter.dump(target, input, state: state)
...
class TerminalShop::Test::CollectionModelTest < Minitest::Test
  A1 = TerminalShop::Internal::Type::ArrayOf[-> { Integer }]
  H1 = TerminalShop::Internal::Type::HashOf[Integer]

  A2 = TerminalShop::Internal::Type::ArrayOf[H1]
  H2 = TerminalShop::Internal::Type::HashOf[-> { A1 }]

  A3 = TerminalShop::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = TerminalShop::Internal::Type::HashOf[Integer, nil?: true]
...
class TerminalShop::Test::BaseModelTest < Minitest::Test
  ...
  class M3 < TerminalShop::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < TerminalShop::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, TerminalShop::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = TerminalShop::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = TerminalShop::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(TerminalShop::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue TerminalShop::Errors::ConversionError => e
...
class TerminalShop::Test::UnionTest < Minitest::Test
  ...
  class M2 < TerminalShop::Internal::Type::BaseModel
  ...
  class M4 < TerminalShop::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, TerminalShop::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < TerminalShop::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, TerminalShop::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class TerminalShop::Test::MetaInfoTest < Minitest::Test
  A1 = TerminalShop::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = TerminalShop::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
