...
class TerminalTest < Minitest::Test
  ...
  def test_raises_on_unknown_environment
    e = assert_raises(ArgumentError) do
      Terminal::Client.new(environment: "wrong")
    end
  ...
  def test_client_default_request_default_retry_attempts
    terminal = Terminal::Client.new(base_url: "http://localhost:4010", bearer_token: "My Bearer Token")
    requester = MockRequester.new(500, {}, {})
    terminal.requester = requester

    assert_raises(Terminal::InternalServerError) do
  ...
  def test_client_redirect_307
    ...
    assert_raises(Terminal::APIConnectionError) do
