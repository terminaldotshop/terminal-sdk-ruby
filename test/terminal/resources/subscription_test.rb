...
class Terminal::Test::Resources::SubscriptionTest < Minitest::Test
  def before_all
  ...
  def test_create_required_params
    ...
    assert_pattern do
      response => Terminal::Models::SubscriptionCreateResponse
    end
  end
  ...
  def test_list
    ...
    assert_pattern do
      response => Terminal::Models::SubscriptionListResponse
    end
  end
  ...
  def test_delete
    ...
    assert_pattern do
      response => Terminal::Models::SubscriptionDeleteResponse
    end
  end
end
