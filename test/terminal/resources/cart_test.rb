...
class Terminal::Test::Resources::CartTest < Minitest::Test
  def before_all
  ...
  def test_convert
    ...
    assert_pattern do
      response => Terminal::Models::CartConvertResponse
    end
  end
  ...
  def test_get
    ...
    assert_pattern do
      response => Terminal::Models::CartGetResponse
    end
  end
  ...
  def test_set_address_required_params
    ...
    assert_pattern do
      response => Terminal::Models::CartSetAddressResponse
    end
  end
  ...
  def test_set_card_required_params
    ...
    assert_pattern do
      response => Terminal::Models::CartSetCardResponse
    end
  end
  ...
  def test_set_item_required_params
    ...
    assert_pattern do
      response => Terminal::Models::CartSetItemResponse
    end
  end
end
